...
//	var checkboxarr = $("#library .ui.checkbox.checked");
	...
	for(var i=0;i<rowsarr.length;i++){
		...
		var url="/survey/increase/question/select";
		var json={"id":id};
		var successFunc = function(data){
...
$("#wcbj").on("click",function(){
	var url="/survey/increase/commit";
	var isFinished = 1;
	...
	var successFunc = function(data){
		alertokMsg(getLangStr("surveyAdd_alert41"),getLangStr("alert_ok"),"window.location.href='/survey'");
	}
	sentJson(url,json,successFunc);
})
$("#wjzc").on("click",function(){
	...
	var successFunc = function(data){
		alertokMsg(getLangStr("surveyAdd_alert41_temp"),getLangStr("alert_ok"),"window.location.href='/survey'");
	}
	sentJson(url,json,successFunc);
})
$("#wcbj_update").on("click",function(){
	...
	var successFunc = function(data){
		alertokMsg(getLangStr("surveyAdd_alert41_update"),getLangStr("alert_ok"),"window.location.href='/survey'");
	}
	sentJson(url,json,successFunc);
})
