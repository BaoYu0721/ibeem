...
function searchUser(searchContent){
	...
	//清除当前页面上的数据
	 ...
	 addLoading($('body'));
	 var url="/project/single/member/search";
...
function okFunc(){//调用删除项目接口
	var url = "/project/single/member/delete";
	//获取选中成员id
...
function addroleFunc(){//调用设为管理员接口
	var url = "/project/single/member/set_manager";
	//获取选中成员id
	$(".memberList .member-item a.click").each(function(){
		var memberId = $(this).data("id");
...
function deleteroleFunc(){//调用撤销管理员接口
	var url = "/project/single/member/manager_revocation";
	//获取选中成员id
	$(".memberList .member-item a.click").each(function(){
		var memberId = $(this).data("id");
		var memberRole = $(this).data("role");
...
$(".button-add").on("click",function(){
	var url = "/project/single/member/add";
	//获取选中成员id
