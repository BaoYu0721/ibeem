...
/*		if(!reg_time.test(start_time)){
		...
		/*		$(".error h4").html("请选择关联问卷");
			...
			//发送
			var url = "/admin/addBuildingPoint";
			...
			function successFunc(data){
				alertokMsg(getLangStr("add_point_messg5"),getLangStr("determine"),"window.location.href='/redirect?url=administrator/teamBuildingPoint.jsp\'");
			}
