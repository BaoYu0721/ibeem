...
//		$('#datatable_wrapper').find(".answerUrl").each(function(){
//			
//			$(this).zclip({
//				path: "/static/common/js/ZeroClipboard.swf",
//				copy: function(){
...
function editSurvey(){
	...
	window.location.href="/survey?item=increase&mode=modify";
}
//未编辑完的，点击进入编辑	    
...
$("#surveyReport").click(function(){
	...
	$.cookie("gxpointId","");
	$.cookie("gxpointName","");
	window.location.href="/survey?item=statistics"
})
//点击问卷分析按钮
$("#surveyAnalysis").click(function(){
	...
	window.location.href="/survey?item=analyze"
});
//点击下载答卷按钮
...
$("#gotoReport").click(function(){
	...
	window.location.href="/redirect?url=manage/surveyReport.jsp"
})
//删除问卷
