...
//	var json={"projectID":teamID};
	...
	var successFunc = function(data){
		...
		//上一页下一页，国际化
		$("#datatable_previous").html(getLangStr("datatable_previous"));
		$("#datatable_next ").html(getLangStr("datatable_next"));
	}
...
$("#addSurvey").click(function(){
	window.location.href="/redirect?url=manage/surveyAdd.jsp"
})
var surveyArr;
