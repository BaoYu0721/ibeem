...
module.exports = app => {
  ...
  router.post('/project/single/topBuilding/room_del', userRequired, controller.project.singleBuilding.topBuildingRoomDel);
  ...
  router.post('/admin/project/single/topBuilding/room_del', adminRequired, controller.admin.project.singleTopBuildingRoomDel);
